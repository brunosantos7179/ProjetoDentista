...
public class ProteseFixa extends JFrame {
    public ProteseFixa() {
        ...
        txtpnEspecialidade.setText("A Ortodontia na Clínica Maeda enfatiza a criação de sorrisos através de uma abordagem que combina conforto, estética e resistência. Além disso, oferece soluções avançadas para substituir dentes mal formados, muito destruídos ou perdidos, destacando-se as próteses fixas. ");
        txtpnEspecialidade.setBounds(33, 200, 200, 205);
        getContentPane().add(txtpnEspecialidade);        
        
        JLabel lblNewLabel_1 = new JLabel("");
        lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\bbrun\\eclipse-workspace\\ProjetoDentista\\ProjetoDentista\\src\\view\\PróteseFixa.jpg"));
